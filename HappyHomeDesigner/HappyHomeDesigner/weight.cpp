...
void SetVertexWeight(void)
{
	...
	// 頂点座標の設定
	pVtx[0].vtx = D3DXVECTOR3(0.0f, TEXTURE_WEIGHT_SIZE_Y-(Power*TEXTURE_WEIGHT_SIZE_Y), 0.0f);
	pVtx[1].vtx = D3DXVECTOR3(0.0f + TEXTURE_WEIGHT_SIZE_X, TEXTURE_WEIGHT_SIZE_Y - (Power * TEXTURE_WEIGHT_SIZE_Y), 0.0f);
	pVtx[2].vtx = D3DXVECTOR3(0.0f, TEXTURE_WEIGHT_SIZE_Y, 0.0f);
	pVtx[3].vtx = D3DXVECTOR3(0.0f + TEXTURE_WEIGHT_SIZE_X, TEXTURE_WEIGHT_SIZE_Y, 0.0f);
