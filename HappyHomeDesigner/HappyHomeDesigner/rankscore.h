...
#define	RANKSCORE_SIZE_X		(25.0f*SCREEN_SCALE)							// スコアの数字の幅
#define	RANKSCORE_SIZE_Y		(80.0f*SCREEN_SCALE)						// スコアの数字の高さ
...
#define	RANKSCORE_POS_Y			(280*SCREEN_SCALE)				// スコアの表示基準位置Ｙ座標
