...
// ミニマップポリス
#define TEXTURE_MINIMAP_POLICE				("data/TEXTURE/ポリスミニマップ.png")								// ポリス画像
#define MINIMAP_POLICE_POS_X				(TEXTURE_MINIMAP_POLICE_SIZE_X)
#define MINIMAP_POLICE_POS_Y				(SCREEN_HEIGHT - TEXTURE_MINIMAP_POLICE_SIZE_Y)
#define TEXTURE_MINIMAP_POLICE_SIZE_X		(15 / 2 * SCREEN_SCALE)												// テクスチャサイズ
#define TEXTURE_MINIMAP_POLICE_SIZE_Y		(15 / 2 * SCREEN_SCALE)												// 同上
#define MINIMAP_POLICE_MAX					(3)																	// ミニマップポリス最大数
#define MINIMAP_POLICE_RANGE				(15.0f)																// ミニマップポリスの位置制御(スマホの枠からはみ出ないように)
