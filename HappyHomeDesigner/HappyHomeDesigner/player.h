...
#define	PLAYER_MODEL				"data/MODEL/PLAYER/player_body.x"		// 読み込むモデル名
#define	PLAYER_SCALE_X				(1.0f * 1.0)							// スケールのX成分
#define	PLAYER_SCALE_Y				(1.0f * 1.0)							// スケールのY成分
#define	PLAYER_SCALE_Z				(1.0f * 1.0)							// スケールのZ成分
// ポリス右アーム関係
